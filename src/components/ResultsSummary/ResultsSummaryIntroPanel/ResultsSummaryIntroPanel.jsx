...
function ResultsSummaryIntroPanel({ children }) {
  return (
    <div className='flex flex-col items-center w-full text-white bg-gradient-to-b from-violet-400 via-violet-500 to-violet-600 pt-400 px-600 pb-600 md:pt-600 md:pb-700 rounded-b-500 md:rounded-500'>
      <h1 className='font-extrabold text-neutral-300 text-18-24'>{cmsConfig.mainHeading}</h1>
      <p className='flex flex-col items-center content-center p-6 my-400 md:mt-500 rounded-full aspect-square w-[8.75rem] md:w-[12.5rem] bg-gradient-to-b from-violet-800 to-violet-100'>
